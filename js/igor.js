$(document).ready(function(){
    ...
    $("#ddlistasortCuk").change(onSortProducts);
    $("#ddlistafilterCuk").change(onFilterProducts);
});

/*ispisivanje mini divova u sadrzaju u igoru*/
function prikaziMiniCuk(){
    $.ajax({
        url:"data/igormini.json",
        method:"get",
        dataType:"json",
...
function ispisiMiniCuk(data){
    ...
    document.querySelector(".igor").innerHTML = ispis;

    $(".igor a").click( function(event) {
...
/*ispisivanje proizvoda u igoru*/
function prikaziCukproizvode(){
    $.ajax({
        url:"data/proizvodi.json",
        method:"get",
        dataType:"json",
        success:function(data){
            ispisiCukproizvode(data);
        },
...
function ispisiCukproizvode(data){
    ispis="";
    for(var d of data){
        if(d.kategorija == "igor"){
        ispis+=`<div class="pr">
        <div class="slikaP">
    ...
    document.querySelector("#cukproizvodi").innerHTML = ispis;
    bindCartEvents();
}
...
function addToCart() {
    ...
    console.log(products);//vrednost je null
    if(products != null) {
...
/*filtriranje proizvoda za igor stranu*/
function onFilterProducts(e){
 ...
 function filtrirajProizvodeCuk(id, data){
    ...
    ispisiCukproizvode(filterniz);
 }
/*sortiranje proizvoda za igor stranu*/
function onSortProducts(e){
 ...
 function sortirajProizvodeCuk(id, data){
     if(id == 'ascza'){
