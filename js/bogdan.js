$(document).ready(function(){
    ...
    $("#ddlistasortB").change(onSortProducts);
    $("#ddlistafilterB").change(onFilterProducts);
});

/*ispisivanje mini divova u sadrzaju u bogdanu*/
function prikaziMiniB(){
    $.ajax({
        url:"data/bogdanmini.json",
        method:"get",
        dataType:"json",
...
function ispisiMiniB(data){
    ...
    document.querySelector(".bogdan").innerHTML = ispis;

    $(".bogdan a").click( function(event) {
...
/*ispisivanje proizvoda u bogdanu*/
function prikaziBproizvode(){
    $.ajax({
        url:"data/proizvodi.json",
        method:"get",
        dataType:"json",
        success:function(data){
            ispisiBproizvode(data);
        },
        error: function(xhr, error, status){
            alert("prikazBp");
        }
...
function ispisiBproizvode(data){
    ispis="";
    for(var d of data){
        if(d.kategorija == "bogdan"){
        ispis+=`<div class="pr">
        <div class="slikaP">
    ...
    document.querySelector("#bproizvodi").innerHTML = ispis;
    bindCartEvents();//dodati u druge js-odavde
} 
...
/*filtriranje proizvoda za bogdan stranu*/
function onFilterProducts(e){
 ...
 function filtrirajProizvodeB(id, data){
...
function onSortProducts(e){
 ...
 function sortirajProizvodeB(id, data){
