$(document).ready(function(){
    ...
    $("#ddlistasortL").change(onSortProducts);
    $("#ddlistafilterL").change(onFilterProducts);
});

/*ispisivanje mini divova u sadrzaju u leni*/
function prikaziMiniL(){
    $.ajax({
        url:"data/lenamini.json",
        method:"get",
        dataType:"json",
...
function ispisiMiniL(data){
    ...
    document.querySelector(".lena").innerHTML = ispis;

    $(".lena a").click( function(event) {
...
/*ispisivanje proizvoda u leni*/
function prikaziLproizvode(){
    $.ajax({
        url:"data/proizvodi.json",
        method:"get",
        dataType:"json",
        success:function(data){
            ispisiLproizvode(data);
        },
        error: function(xhr, error, status){
            alert("prikaziLp");
        }
...
function ispisiLproizvode(data){
    ispis="";
    for(var d of data){
        if(d.kategorija == "lena"){
        ispis+=`<div class="pr">
        <div class="slikaP">
    ...
    document.querySelector("#lenaproizvodi").innerHTML = ispis;
    bindCartEvents();
}
...
/*filtriranje proizvoda za lena stranu*/
function onFilterProducts(e){
 ...
 function filtrirajProizvodeL(id, data){
    ...
    ispisiLproizvode(filterniz);
 }
/*sortiranje proizvoda za lena stranu*/
function onSortProducts(e){
 ...
 function sortirajProizvodeL(id, data){
     if(id == 'ascza'){
